...
export default function Footer() {
  return (
    <footer className="px-4 divide-y bg-[#025464] text-gray-100">
        ...
        <div className="lg:w-1/3">
          <Link to="/" className="flex justify-center space-x-3 lg:justify-start">
            <div className="flex items-center justify-center  rounded-full bg-yellow-500 p-2">
              <AiFillCar className="text-white text-2xl" />
            ...
            <span className="self-center text-2xl font-semibold">PowerTrain</span>
          </Link>
        </div>
      ...
      <div className="py-6 text-sm text-center text-gray-400">© 2021 Oga Landlord. All rights reserved.</div>
    </footer>
  )
}
