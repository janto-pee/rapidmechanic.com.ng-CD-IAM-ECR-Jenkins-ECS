export default function BannerWForm() {
  return (
    <div className="bg-yellow-500">
      <div className="w-[95%] lg:w-[90%] mx-auto py-8">
        <div className="container mx-auto">
          <div className="flex flex-col lg:flex-row items-center justify-between">
            <h2 className="text-center text-3xl tracking-tighter">
              Up to
              <br className="sm:hidden" />
              30% Off
            </h2>
            <div className="space-x-2 text-center py-2 lg:py-0">
              <span>Plus Auto Testing! Use code:</span>
              <span className="font-bold text-lg">ECU-ONLINE</span>
            </div>
            <a
              href="#"
